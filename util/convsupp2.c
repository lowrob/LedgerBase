/*-----------------------------------------------------------------------
Source Name: convsupp1.c
System     : Budgetary Financial system.
Module     : Purchase Order
Created  On: Feb 17, 1993  
Created  By: S. Whittaker
...
#define	MOD_DATE	"17-FEB-93"		/* Program Last Modified */
...
typedef struct {
	...
	char	s_gst_reg;      /* GST registration number */
	} Old_supplier;
...
char *argv[];
{
	...
	for( ; ; ) {
		...
		strcpy(supplier.s_gst_reg, old_supplier.s_gst_reg);
		supplier.s_min_dollar = 0;
