/*-----------------------------------------------------------------------
Source Name: convrqit1.c
System     : Budgetary Financial system.
Module     : General Ledger
Created  On: Sept. 27, 1993  
...
typedef struct {
	...
	char	bdgt_flag;	/* Over Budget Flag */
	short	stock_fund;	/* Used in Interfunding */
	} Old_reqitem;
...
char *argv[];
{
	...
	for( ; ; ) {
		...
		strcpy(reqitem.bdgt_flag, old_reqitem.bdgt_flag);
		reqitem.cat_num = 0;
