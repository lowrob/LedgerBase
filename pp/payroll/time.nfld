...
/*	if(trans.tr_lp_sum[0] != 'Y' && vac_flg == 0){*/
	...
	if(att_flg == 1){
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[0] /
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[1] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[2] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[3] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[4] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[5] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
		...
		for(;;) {
			...
			if(strcmp(att.at_sick, "Y")==0){ 
				sick_bal -= s_sth.s_items[item_no].s_units[6] /
					sen_par.sn_num_hrs_day;
				if(sick_bal <= 0){ 
					retval = GetOption((char *)&s_sth,
					"Balance less that 0, Change (Y/N)" ,"YN");
