/*------------------------------------------------------------------------
Source Name: mass_roe.c
System     : Personnel/Payroll System.
Created  On: June 7th, 1993.
Created  By: Andre Cormier

DESCRIPTION:
	Program to mass select employee's to receive ROE's.
...
#define	SYSTEM		"ROE"	/* Sub System Name */
#define	MOD_DATE	"07-JUNE-93"		/* Program Last Modified */
...
#define	SCR_NAME	"mass_roe"	/* PROFOM screen Name */

/* Field PROFOM numbers */
#define START_FLD 	400	/* Start Field in range */
#define	END_FLD		2700	/* Last Field of the screen */

#define	STEP		100

#define TERM_FLD	800	/* Termination Code */	
#define TERM_DESC	900	/* Termination Description */	
#define BARG1		1800	/* Employee Number */
#define BARG2		1900	/* Employee Number */
#define POS1		2000	/* Employee Number */
#define POS2		2100	/* Employee Number */
#define EMP1		2200	/* Employee Number */
#define EMP2		2300	/* Employee Number */
#define OPTION		2400	/* Option response field */
#define MESSAGE		2500	/* Message Field */
#define RESPONSE	2600	/* Response Field */
...
typedef struct	{
	...
	long	s_first_date;	/* 700 last day of work */
...
static	double	one_wks_min_earn, one_wks_min_hrs, one_wks_max_earn,
		one_wks_yrly_earn, total_uic;
static	int	count,k,done,all_wks_max,first_time;
...
/* Do not put anythng in these fields for now Lou */
for(i=0;i<27;i++){
	roe.ro_ins_earn[i] = 0;
	roe.ro_ins_wks[i] = 0;
}
...
{
	int 	retval, i = 0, j = 0;
	short	last_pp_numb, last_pp_year, no_weeks, prev_pp, prev_year;
...
long	date;
{
	...
	one_wks_yrly_earn = uic_table.ui_yrly_earn;
...
GetStatus()
{
	int 	retval,i,j, curr_month, leap_year ;
