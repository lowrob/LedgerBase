...
/* this next segment of code is used to fool the program since
the program expects the checks to be run on the end date of the pay
period and in theses three pay periods they were not so mods were made
to bandage this  - Nicola McKee  - for the 1992 - 1993 t4's */
...
/* end of segment - can be removed for the 1993 -1994 T4's */
