...
****/
	...
	tedit((char*)&roe.ro_hours,"__,___._0",temp_buf,R_DOUBLE);
	mkln(34,temp_buf,9) ; 
...
/*** Not working
	...
	mkln(35,temp_buf,9) ; 
****/
	tedit((char*)&roe.ro_earnings,"__,___._0",temp_buf,R_DOUBLE);
	mkln(34,temp_buf,9) ; 
	...
	if( prnt_line() < 0) return(-1) ;
	if( prnt_line() < 0) return(-1) ;
/* Temporary, used for total ins weeks and total ins earnings for last year */
	tedit((char*)&roe.ro_ins_earn[2],"____",temp_buf,R_DOUBLE);
	mkln(49,temp_buf,4) ; 
	tedit((char*)&roe.ro_ins_earn[3],"__,___._0",temp_buf,R_DOUBLE);
	mkln(71,temp_buf,9) ; 
