...
static	long	start_month, start_date;
...
static	double	mtd_att_sic[12], mtd_att_vac[12], ytd_att_sic[12],
		...
		hinc, calytd, schytd,
		ytd_def,ytd_tax,ytd_cpp,ytd_cpp_pen,ytd_uic,
		ytd_uic_earn,ytd_pen_rate1,
		ytd_pen_rate2,ytd_pen_rate3,
		init_perm_days, init_cas_days,
		bal_sic, bal_vac;
static	short	perm_yrs[12], cas_yrs[12],
