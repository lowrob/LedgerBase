...
*	Source 	: repstat.c 
*
*	Program to Print Statutory Holiday Codes using REPORT GENERATOR.
*	By : Andre Cormier
...
short	err;
	...
	for( ; ; ) {
		code = get_n_stat(&stat,BROWSE,0,FORWARD,e_mesg);
