...
*	Source 	: repatt.c 
*
*	Program to Print Attendance Codes using REPORT GENERATOR.
*	By : Andre Cormier
...
short	err;
	...
	att.at_disp_code[0] = '\0';
	att.at_code[0] = '\0';

	flg_reset(ATT);

	for( ; ; ) {
		code = get_n_att(&att,BROWSE,0,FORWARD,e_mesg);
