/* ---------------------------------------------------------------------------
*	Source 	: reparea_spec.c 
*
*	Program to Print Area of Specialization Codes using REPORT GENERATOR.
*	By : Eugene Roy
...
short	err;
	...
	if(outcntl == 1) {
		if(e_mesg[0]==FILE_IO) {
			STRCPY(e_mesg,"reparea_spec.dat");
