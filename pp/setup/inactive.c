...
*	Source 	: inactive.c 
*
*	Program to Print Inactivation Codes using REPORT GENERATOR.
*	By : Andre Cormier
...
short	err;
	...
	for( ; ; ) {
		code = get_n_inact(&inact,BROWSE,0,FORWARD,e_mesg);
