...
*	Source 	: posrep.c 
*
*	Program to Print position information using REPORT GENERATOR.
*	By : Sheldon Floyd
...
short	err;
	...
	for( ; ; ) {
		code = get_n_position(&pos,BROWSE,0,FORWARD,e_mesg);
