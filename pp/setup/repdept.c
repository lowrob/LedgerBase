...
*	Source 	: repdept.c 
*
*	Program to Print Department Codes using REPORT GENERATOR.
*	By : Andre Cormier
...
short	err;
	...
	for( ; ; ) {
		code = get_n_dept(&dept,BROWSE,0,FORWARD,e_mesg);
