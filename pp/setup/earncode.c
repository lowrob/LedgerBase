...
*	Source 	: earncode.c 
*
*	Program to Print the List of Earning Codes Table using REPORT GENERATOR.
*	By : Andre Cormier
...
short	err;
	...
	/* For Terminals set pagesize to 222 lines */ 
	if(outcntl == 0)
		rpPagesize(22);
	...
	for( ; ; ) {
		code = get_n_earn(&earn,BROWSE,0,FORWARD,e_mesg);
