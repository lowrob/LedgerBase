...
/* Do all sick accruals */
	/* Write sick accruals for june */
	/* emp_rec.em_sck_acc[0] = s_sth.s_items[0].s_sck_acc;*/
	emp_rec.em_vac_acc[0] = s_sth.s_items[0].s_vac_acc;
	/* Write sick accruals for august */
	/*emp_rec.em_sck_acc[1] = s_sth.s_items[1].s_sck_acc;*/
	emp_rec.em_vac_acc[1] = s_sth.s_items[1].s_vac_acc;
	/*emp_rec.em_sck_acc[11] = s_sth.s_items[11].s_sck_acc;*/
	emp_rec.em_vac_acc[11] = s_sth.s_items[11].s_vac_acc;
	for(i=0;i<12;i++){
		emp_rec.em_sck_acc[i] = s_sth.s_items[i].s_sck_acc;
	/*	emp_rec.em_vac_acc[i] = s_sth.s_items[i].s_vac_acc;Louis*/
	}
...
int	mode;
{
	...
	if(mode == ADD) {
		...
		/* Allow sick accruals for june to be edited */
		/*s_sth.s_items[0].s_sck_acc = LV_DOUBLE;*/
		s_sth.s_items[0].s_vac_acc = LV_DOUBLE;
		/* Allow sick accruals for august to be edited */
		/*s_sth.s_items[1].s_sck_acc = LV_DOUBLE;*/
		s_sth.s_items[1].s_vac_acc = LV_DOUBLE;
		/*s_sth.s_items[11].s_sck_acc = LV_DOUBLE;*/
		s_sth.s_items[11].s_vac_acc = LV_DOUBLE;

		for( i = 0; i < 12; i++){
			s_sth.s_items[i].s_sck_acc = LV_DOUBLE;
			/*s_sth.s_items[i].s_vac_acc = LV_DOUBLE;Louis*/
		}
	}
