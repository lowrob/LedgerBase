...
struct	rs_struct	{
	...
	char	s_option[3];	/* STRING X Field 1500 */

	short	s_sort_keys[USER_KEYS] ;/* NUMERIC 99 Field 1600 to 2200 */

	char	s_output[2];	/* STRING X Field 2300 */
	short	s_copies;	/* NUMERIC 99 Field 2400 */
	char	s_filenm[15];	/* STRING X[14] Field 2500 */

	short	s_fm_fund;	/* NUMERIC 999 Field 2600 */
	short	s_to_fund;	/* NUMERIC 999 Field 2700 */

	short	s_period ;	/* NUMERIC 99 Field 2800 */

	short	s_sort_no ;	/* NUMERIC 99 Field 2900 */

	long	s_fm_ccno ;	/* NUMERIC 99999 Field 3000 */
	long	s_to_ccno ;	/* NUMERIC 99999 Field 3100 */

	long	s_fm_key8 ;	/* NUMERIC 99999 Field 3200 */
	long	s_to_key8 ;	/* NUMERIC 99999 Field 3300 */

	char	s_mesg[78];	/* STRING X[77] Field 3400 */
	int	s_resp;		/* YES/NO B Field 3500 */
...
#define	END_FLD		3500		/* Last Field in PROFOM Screen */

/* PROFOM Field#s */

#define	OPTION_FLD	1500		/* Option: */
#define	SORT_KEYS	1600		/* Keys: */
#define	OPTION_START	1600		/* Keys: */
#define	OPTION_END	3300		/* Key-8's To: */
#define	OUTPUT_ON_FLD	2300		/* Output On: */
#define	COPIES_FLD	2400		/* No of Copies: */
#define	FILE_FLD	2500		/* File Name: */
#define	FUND_FM_FLD	2600		/* Fund */
#define	FUND_TO_FLD	2700		/* Fund To */
#define	PERIOD_FLD	2800		/* Period: */
#define	SORT_NO_FLD	2900		/* Sort#: */
#define CC_FM_FLD	3000		/* Cost Center Keys */
#define CC_TO_FLD	3100		/* Cost Center Keys To */
#define	KEY8_FM_FLD	3200		/* Key 8's */
#define	KEY8_TO_FLD	3300		/* Key 8's To */
