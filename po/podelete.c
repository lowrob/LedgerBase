...
#define REQ_FLD		2000	/* Requisition number */
...
typedef	struct	{	/* Start Fld 3000, Endfld 7100 and Step 1400 */
...
typedef struct	{
	...
	double  s_po_amt;	/* NUMERIC 99999999.99 Field 1100 */
	long	s_entry_dt;	/* STRING XXXXXXXX Field 900 */
	long	s_due_dt;	/* STRING XXXXXXXX Field 1300 */
	double  s_liq_amt;	/* NUMERIC 99999999.99 Field 1500 */
	short	s_period;	/* NUMERIC 99 Field 1400 */
	short	s_fund;		/* NUMERIC 999 Field 1000 */
	long	s_liq_dt;	/* STRING XXXXXXXX Field 1700 */
	short	s_shipto;	/* NUMERIC 99 Field 1600 */
	char	s_type[2];	/* STRING X Field 1800 */
	short	s_billto;	/* NUMERIC 99 Field 1200 */
	char	s_req_no[11];	/* STRING X(15) Field 2000 */
	...
	char	s_dummy1[3];	/* STRING X Field 2300 */

	S_item	s_items[PAGESIZE] ;	/* Start Fld 3000, End Fld 7100 and
					   Step 1400 */

	double	s_total_po;	/* NUMERIC  Field 5500 */
	double	s_total_itm;	/* NUMERIC  Field 5600 */
	double	s_total_diff;	/* NUMERIC  Field 5700 */
