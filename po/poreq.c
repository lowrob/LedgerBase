...
A.Cormier     92/11/16        default Ship To field to be the warehouse 
				costcenter #.
------------------------------------------------------------------------*/
...
#define TOTAL_ST_FLD	5800	/* Totals Start Field */
#define TOTAL_END_FLD	6000	/* Totals End Field */
...
typedef	struct	{	/* Start Fld 2400, Endfld 5700 and Step 1700 */
	...
	long	s_reqno;	/* NUMERIC 99999999 Field 4000 */
}	S_item ;
...
typedef struct	{
	...
	char	s_attention[16];/* STRING X(15) Field 2000 */
	char	s_status[2];	/* STRING X Field 2100 */
	short	s_page_no;	/* NUMERIC 99 Field 2200 */
	char	s_dummy1[2];	/* STRING X Field 2300 */

	S_item	s_items[PAGESIZE] ;	/* Start Fld 2400, End Fld 5700 and
					   Step 1700 */
	double	s_total_po;	/* NUMERIC 9999999.99 Field 5800 */
	double	s_total_itm;	/* NUMERIC 9999999.99 Field 5900 */
	double	s_total_diff;	/* NUMERIC 99999999.99 Field 6000 */
...
ReadHdr()
{
	...
	/* Show warehouse cc# as default */
	s_sth.s_shipto = pa_rec.pa_wareccno ;
	SetDupBuffers(SHIPTO_FLD,SHIPTO_FLD,1);
