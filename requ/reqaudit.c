...
*	Source 	: reqaudit.c 
*
*	Program to Print Requisitions Over Budget by G/L account.
*
...
short	err;
	...
	for( ; ; ) {
		...
		if(req_hdr.funds > fund2) {  /* fund range */
			break;
		}
